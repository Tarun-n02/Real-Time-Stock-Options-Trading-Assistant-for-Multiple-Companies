...
def train_model(data):
    """
    Train a LightGBM Classifier to predict Buy/Sell signals.
    """
    loaded_model = 'lightBG_model.pkl'
    if not os.path.exists(loaded_model):
        ...
        joblib.dump(model, 'lightBG_model.pkl')
        return model
    else:
        print("loaded")
        return joblib.load('lightBG_model.pkl')
